# Dormant Mode Pinned Update Draft

CHATTY is now in dormant autopilot mode.

Canonical site/repo:

- https://dicnunz.github.io/CHATTY-Revival/
- https://github.com/dicnunz/CHATTY-Revival
- Telegram invite link, if intentionally public: https://t.me/+7A8xRcI8IHM3MWIx

Contract:

`jSHyGRfqkGBKdjUPrZXaqPXzFpBTjimJtheWZJRpump`

The project is unofficial and not affiliated with OpenAI, ChatGPT, or any other company. The creator may benefit financially from trading activity and/or creator fees. This is not financial advice. No promises, no guarantees. Meme tokens are highly volatile and can go to zero. Do your own research.
