...
BANNED = {
    ...
    r"\bbuy every dip\b": "Use: do your own research and understand risk.",
    r"\bdon[’']t fade\b": "Use: no urgency or pressure.",
    r"\braid(?:s| this)?\b": "Use only in moderation examples, not project messaging.",
    r"\bsendor\b": "Use: public transparency log updated.",
    r"\blfg\b": "Use: no hype language.",
    r"\b1m\b": "Use: no market-cap targets.",
    r"\b100k soon\b": "Use: no market-cap targets.",
    r"\bmillions\b": "Use: no market-cap targets.",
    r"\bmillion coded\b": "Use: no market-cap targets.",
    r"\bnext stop\b": "Use: no price/market-cap targets.",
    r"\bdiamond hand\b": "Use: no hold or trading pressure.",
    ...
    r"\bdex paid officially\b": "Use: payment source unknown unless verified.",
    r"\bwith dex this moon hard\b": "Use: DEX visibility is not a price promise.",
    r"\bmoon hard\b": "Use: no price hype.",
    r"\bdev followed by chatgpt\b": "Avoid implying affiliation or endorsement.",
    r"\bofficial launch\b": "Use: unofficial community experiment.",
    r"\bendorsed by chatgpt\b": "Use: not affiliated with OpenAI/ChatGPT.",
    r"\bchatgpt mascot\b": "Use: unofficial mascot, not affiliated.",
    r"\bopenai mascot\b": "Use: unofficial mascot, not affiliated.",
    r"\bcreator rewards\b": "Avoid fund/reward language.",
    r"\bdonations\b": "Avoid fund collection language.",
    r"\bwallet for donations\b": "Avoid fund collection language.",
}
